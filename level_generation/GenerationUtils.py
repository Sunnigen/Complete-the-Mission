...
def place_entities(game_map, dungeon_level, room, entities, item_table, mob_table, object_table):
    ...
    # Generate Monsters
    monster_list = generate_mobs(entities, game_map, room, number_of_mobs, monster_chances, mob_table,
...
def generate_mobs(entities, game_map, room, number_of_mobs, monster_chances, mob_table, encounter_type, encounter):
    # return []
    # for e in entities:
    #     if e.ai:
    #         return []
