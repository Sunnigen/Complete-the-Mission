...
def voronoi_finite_polygons_2d(vor, radius=None):
    """
    Obtained from https://gist.github.com/pv/8036995
    ...
    # print('all ridges')
    # for key, val in all_ridges.items():
    #     print(key, val)
...
if __name__ == '__main__':
    ...
    plt.axis('equal')
    bound = 0.1
    plt.xlim(vor.min_bound[0] - bound, vor.max_bound[0] + bound)
    plt.ylim(vor.min_bound[1] - bound, vor.max_bound[1] + bound)
